...
| ----------- | ------------------------------------------------------ | ------------------------------------------------------------- |
| `viewer`  | Can view shared results but cannot trigger simulations | `can_view_analysis`                                         |
| `analyst` | Standard user — can propagate and analyze              | `can_propagate`, `can_view_analysis`                       |
| `manager` | Can propagate and manage team members' roles            | `can_propagate`, `can_view_analysis`, `can_manage_users` |
